...
trace_enabled = config.getboolean('common', 'trace_enabled')
...
def trace(func):
    ...
    def wrapper(*args):
        ...
        trace_log.write("Enter the method  \"{}\" \n  args: {} \n" .format(func.__name__, args))
        trace_log.close()
        func(*args)
        trace_log = open("trace.log", "a")
        trace_log.write("Exit the method \"{}\" \n" .format(func.__name__))
        trace_log.close()
...
class CollectedData:
    ...
    """ defines data to collect from system """
